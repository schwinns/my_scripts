...
if __name__ == '__main__':
    ...
    # NPT (100 ns)
    npt_tpr = grompp(input_gro, mdp_file, top=input_top, tpr=f'prod.tpr', gmx=gmx(1), flags={'maxwarn' : 1}, cwd='./production/')
    npt_gro = mdrun(npt_tpr, output=f'prod', gmx=gmx(128), cwd='./production/')